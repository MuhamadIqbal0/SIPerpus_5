    ...
    <section class="bg-gradient-to-br from-primary/5 via-background to-secondary/20">
      <div class="container mx-auto px-4 py-20 text-center">
        ...
        <h1 class="text-5xl font-extrabold tracking-tight text-foreground mb-4">
          Selamat Datang di
          <span class="text-primary">SiPerpus</span>
        </h1>

        <p class="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
          Kelola koleksi buku, anggota, dan peminjaman dalam satu platform modern berbasis Vue dan Express.js.
        </p>
    ...
    <section class="container mx-auto px-4 py-16">
      ...
      <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card v-for="item in kartuStat" :key="item.id" class="relative overflow-hidden">
          ...
          <CardContent>
            <p v-if="item.sub" class="text-xs text-muted-foreground">
              {{ item.sub }}
            </p>
          </CardContent>

          <div class="absolute right-4 top-4 opacity-10 text-5xl">
            {{ item.ikon }}
          </div>
    ...
    <section class="container mx-auto px-4 pb-16">
      <Card class="max-w-2xl mx-auto">
        ...
        <CardHeader>
          ...
          <CardDescription>
            Gunakan counter di bawah dan perhatikan statistik berubah otomatis
          </CardDescription>
        </CardHeader>
          ...
          <div class="flex gap-8 justify-center flex-wrap">
            ...
            <div class="text-center">
              ...
              <div class="flex items-center gap-3">
                ...
                <Button variant="outline" size="icon" @click="stat.totalBuku++">
                  +
                </Button>
              </div>
            </div>
            ...
            <div class="text-center">
              ...
              <div class="flex items-center gap-3">
                ...
                <Button variant="outline" size="icon" @click="tambah">
                  +
                </Button>
              </div>
            </div>
...
const bukuTersedia = computed(() =>
  stat.totalBuku - stat.peminjamanAktif
)
