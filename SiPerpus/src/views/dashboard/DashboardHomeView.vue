...
<template>
 ...
 <!-- Kartu statistik dari buku store -->
 ...
 <CardTitle class="text-3xl text-green-600">{{ statistik.tersedia
}}</CardTitle>
 </CardHeader>
 </Card>
 <Card>
 ...
 <CardTitle class="text-3xl text-orange-500">{{ statistik.dipinjam
}}</CardTitle>
 </CardHeader>
 </Card>
 <Card>
 <CardHeader class="pb-2">
 <CardDescription>% Tersedia</CardDescription>
 <CardTitle class="text-3xl text-blue-600">{{ statistik.persen
}}%</CardTitle>
 </CardHeader>
 </Card>
 </div>
 ...
 <p class="text-sm text-muted-foreground">Daftarkan koleksi
terbaru</p>
 </div>
 </CardContent>
 </Card>
 ...
 <p class="text-sm text-muted-foreground">Catat pinjam &
kembali</p>
 </div>
 </CardContent>
 </Card>
